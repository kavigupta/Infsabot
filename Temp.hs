...
tests = makeSymmetric [((-32,-34,Robot {robotProgram = basicProgram A, robotTeam = A, robotAppearance = RobotAppearance {robotColor = PixelRGB8 154 156 210}, robotMaterial = 9, robotHitpoints = 20, robotBirthdate = 37, robotMemory = fromList [], robotMessages = []}),Noop),((-34,-32,Robot {robotProgram = basicProgram A, robotTeam = A, robotAppearance = RobotAppearance {robotColor = PixelRGB8 151 115 192}, robotMaterial = 41, robotHitpoints = 30, robotBirthdate = 20, robotMemory = fromList [], robotMessages = []}),Fire $ FireAction {fireDirection = E, materialExpended = -37})]
...
--makeSymmetric [((0,-2,Robot {robotProgram = basicProgram A, robotTeam = A, robotAppearance = RobotAppearance {robotColor = PixelRGB8 1 0 0}, robotMaterial = 3, robotHitpoints = 4, robotBirthdate = 4, robotMemory = fromList [], robotMessages = []}),Spawn $ SpawnAction {newDirection = E, newProgram = basicProgram A, newAppearance = RobotAppearance {robotColor = PixelRGB8 2 1 2}, newMaterial = 2, newMemory = fromList []}),((0,-1,Robot {robotProgram = basicProgram A, robotTeam = B, robotAppearance = RobotAppearance {robotColor = PixelRGB8 0 2 2}, robotMaterial = 3, robotHitpoints = 2, robotBirthdate = 3, robotMemory = fromList [], robotMessages = []}),MoveIn W)]


--makeSymmetric [((-50,1,Robot {robotProgram = basicProgram A, robotTeam = B, robotAppearance = RobotAppearance {robotColor = PixelRGB8 66 168 195}, robotMaterial = 63, robotHitpoints = 63, robotBirthdate = 41, robotMemory = fromList [], robotMessages = []}),Spawn $ SpawnAction {newDirection = S, newProgram = basicProgram A, newAppearance = RobotAppearance {robotColor = PixelRGB8 159 139 144}, newMaterial = 41, newMemory = fromList []}),((-50,2,Robot {robotProgram = basicProgram A, robotTeam = B, robotAppearance = RobotAppearance {robotColor = PixelRGB8 0 195 63}, robotMaterial = 61, robotHitpoints = 3, robotBirthdate = 9, robotMemory = fromList [], robotMessages = []}),MoveIn N)]

{-makeSymmetric [
	((-1,8,Robot {robotProgram = basicProgram A, robotTeam = A, robotAppearance = RobotAppearance {robotColor = PixelRGB8 0 2 3}, robotMaterial = 3, robotHitpoints = 4, robotBirthdate = 4, robotMemory = fromList [], robotMessages = []}),Fire $ FireAction {fireDirection = W, materialExpended = -1}),
	...
	((-2,7,Robot {robotProgram = basicProgram A, robotTeam = A, robotAppearance = RobotAppearance {robotColor = PixelRGB8 7 7 8}, robotMaterial = 5, robotHitpoints = 2, robotBirthdate = 8, robotMemory = fromList [], robotMessages = []}),Spawn $ SpawnAction {newDirection = S, newProgram = basicProgram A, newAppearance = RobotAppearance {robotColor = PixelRGB8 6 7 7}, newMaterial = -4, newMemory = fromList []})
	]
-}
...
{-}[
	...
	((21,10,Robot {robotProgram = basicProgram A, robotTeam = A, robotAppearance = RobotAppearance {robotColor = PixelRGB8 255 0 0}, robotMaterial = 238, robotHitpoints = 100, robotBirthdate = 0, robotMemory = fromList [], robotMessages = []}),Spawn $ SpawnAction {newDirection = E, newProgram = basicProgram A, newAppearance = RobotAppearance {robotColor = PixelRGB8 255 0 0}, newMaterial = 79, newMemory = fromList []}),
	((10,21,Robot {robotProgram = basicProgram A, robotTeam = B, robotAppearance = RobotAppearance {robotColor = PixelRGB8 0 0 128}, robotMaterial = 238, robotHitpoints = 100, robotBirthdate = 0, robotMemory = fromList [], robotMessages = []}),Spawn $ SpawnAction {newDirection = E, newProgram = basicProgram A, newAppearance = RobotAppearance {robotColor = PixelRGB8 0 0 128}, newMaterial = 79, newMemory = fromList []}),
